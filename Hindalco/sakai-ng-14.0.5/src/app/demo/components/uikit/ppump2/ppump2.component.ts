...
@Component({
  ...
  templateUrl: './ppump2.component.html'
})
export class Ppump2Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataService.getPump2DataGraph1().subscribe(
      (result: any) => {
        ...
        const data = result.map((record: any) => record.pump2);
