...
@Component({
  templateUrl: './electrical2.component.html',
})
export class Electrical2Component {
  ...
  rows: any[] = [];
  showForm = false;
  defaultRowType = 'Electrical Systems';
  newRow: {
    type: string;
    sno: string;
