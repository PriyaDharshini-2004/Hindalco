...
@Component({
  ...
  templateUrl: './ppump4.component.html'
})
export class Ppump4Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataService.getPump4DataGraph1().subscribe(
      (result: any) => {
        ...
        const data = result.map((record: any) => record.pump4);
